...
function getProductsFromServer() {
    ...
    fetch('https://matiasgasparg1.pythonanywhere.com/producto/')
        .then(response => {
...
function displayProducts(products) {
    ...
    displayProductsByCategory('Guitarra', categorias['Guitarra']);
    displayProductsByCategory('Bajo', categorias['Bajo']);
    displayProductsByCategory('Bateria', categorias['Bateria']);
    displayProductsByCategory('Microfono', categorias['Microfono']);
