document.addEventListener('DOMContentLoaded', () => {
    ...
    productRegistrationForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('https://matiasgasparg1.pythonanywhere.com/producto/crear', {
                method: 'POST',
                headers: {
    ...
    const uploadImage = async (file) => {
        try {
            ...
            const response = await fetch('https://matiasgasparg1.pythonanywhere.com/imagen/', {
                method: 'POST',
                body: formData
            });
            ...
            const storageUrl = `https://firebasestorage.googleapis.com/v0/b/alelicks-9019e.appspot.com/o/${encodeURIComponent(fileName)}?alt=media`;
